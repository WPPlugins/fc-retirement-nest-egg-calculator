=== FC's Retirement Nest Egg Calculator ===
Contributors: financialcalculators
Donate link:
Tags: calculator, retirement, retirement calculator, future value calculator, investments, retirement planning, plugin, sidebar, widget
...
Either (a) upload the *fc-retirement-nest-egg-calculator* folder with all its files to the */wp-content/plugins/* folder or (b) unzip the plugin's zip file in the */wp-content/plugins/* folder.
...
1. Add the following code *&lt;?php show_fcretirenestegg_plugin(); ?&gt;* to your template where you want the calculator to appear. See below for options.
...
`[fcretirenesteggplugin sc_size="small" sc_custom_style="Yes" sc_hide_resize="Yes"]`
...
__Optional array parameter passed to *show_fcretirenestegg_plugin()*__
...
__Can the Retirement Nest Egg Calculator plugin be used on a commercial website?__
