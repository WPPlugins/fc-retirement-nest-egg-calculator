...
if ($brand_name != '' && strtolower($add_link) == 'yes') {
	$title = $brand_name . "<br>Retirement Calculator";
} else {
	$title = "Retirement Calculator";
}

// rather than using exclusively a CSS solution for setting size
// PHP is used as well so that the text displayed can vary
...
<div id="calc-wrap" class="tiny">  <!--default max-width: 440px, medium: 340px, small: 290px, tiny: 150px-->
		...
		<!--calculator-->
		<form id="retire-nest-egg" class="calculator">

			<!--retirement nest egg calculator-->
			<!-- calculator title -->
			<div class="calc-name"><?php echo ((strtolower($add_link) == 'yes') ? '<a href="https://financial-calculators.com/retirement-calculator" target="_blank" data-toggle="tooltip" data-placement="right" title="click for more advanced calculator by financial-calculators.com">' . $title . '</a>' : $title) ?></div>
				...
				<div class="input-group input-group-sm">
					<label class="control-label">Retirement Nest Egg:</label>
...
<div id="calc-wrap" class="medium">  <!--default max-width: 440px, medium: 340px, small: 290px, tiny: 150px-->
		...
		<form id="retire-nest-egg" class="calculator">
			...
			<div class="calc-name"><?php echo ((strtolower($add_link) == 'yes') ? '<a href="https://financial-calculators.com/retirement-calculator" target="_blank" data-toggle="tooltip" data-placement="right" title="click for more advanced calculator by financial-calculators.com">' . $title . '</a>' : $title) ?></div>
				...
				<div class="input-group">
					<label for="edRate" class="control-label">Annual Rate (ROI)?:</label>
					<input type="text" class="control num" id="edRate" value=<?php echo $rate ?> maxlength="8" size="16" >
				</div>
...
<div id="calc-wrap" class="large">  <!--default max-width: 440px, medium: 340px, small: 290px, tiny: 150px-->
		...
		<form id="retire-nest-egg" class="calculator">
			...
			<div class="calc-name"><?php echo ((strtolower($add_link) == 'yes') ? '<a href="https://financial-calculators.com/retirement-calculator" target="_blank" data-toggle="tooltip" data-placement="right" title="click for more advanced calculator by financial-calculators.com">' . $title . '</a>' : $title) ?></div>
				...
				<div class="input-group">
					<label class="control-label">Available At Retirement:</label>
					<input type="text" class="control num" id="edFV" maxlength="14" size="16" disabled>
				</div>
...
<div class="fc-widget">
	<div id="hShow" class="hidden">
		<div id="hText">
<h2>Retirement Calculator — calculate future value of retirement fund</h2>

<p>This calculator easily answers the question &quot;Given the value of my current investments and assuming future monthly investments of &quot;X&quot;, what will be the value of my retirement nest egg?</p>
<p>The user enters their &quot;Current Age&quot;, their exprected &quot;Retirement Age&quot;, the &quot;Monthly Amount Invested&quot;, and the &quot;Annual Interest Rate (ROI)&quot; (annualized Return on Investment one expects to earn).</p>
<p class="tail">The calculator quickly calculates the expected final value of their investments and creates an investment schedule plus a set of charts that will help the user see the relationship between the amount invested and the return on the investment. The schedule can be copied and pasted to Excel, if desired.</p>
...
<!--end retirement nest egg calculator plugin-->
